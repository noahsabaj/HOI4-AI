...
- a stream per PC: the second PC's game window at 30 frames a second from its worker's
...
- replays of any game played, made from its recording on request (replay.py);
...
__all__ = [
    "Feed", "Flags", "Follower", "History", "LiveApp", "LocalView", "Narrator", "PeerView",
    "Replays", "capture_command", "clear_stream", "draw_icon", "game_card", "hls_command",
